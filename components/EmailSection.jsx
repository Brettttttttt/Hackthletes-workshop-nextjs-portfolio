        ...
        <main className="grid md:grid-cols-2 my-12 md:my-12 py-24 md:py-24 gap-4 relative" id="contact">
            <div className="z-10">
                ...
                <div className=" flex flex-row gap-4 mt-6">
                    <Link href="https://github.com/Brettttttttt">
                        <Image src={GithubIcon} alt="Github Icon" />
                    </Link>
                    <Link href="https://www.linkedin.com/in/eten-chieu-315032251/">
                        <Image src={LinkedinIcon} alt="Linkedin Icon" />
                    </Link>
                    <Link href="https://www.instagram.com/chieueten/" className="mt-1">
                        <Image src={InstagramIcon}/>
                    </Link>
                    <Link href="mailto:chieueten@gmail.com" className="mt-1">
                        <Image src={GmailIcon}/>
                    </Link>
